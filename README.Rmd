...
The goal of theGame is to demonstrate a complete R package development process.

## Installation

You can install the development version of theGame from [GitHub](https://github.com/) with:
